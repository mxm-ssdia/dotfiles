vim.opt.number = true -- enable line no
...
vim.g.have_nerd_font = false -- disable if nerd font is applied on terminal
vim.o.confirm = true -- open dialog when operation fail :q tells to save 
